<template>
	<div class="flex content-center items-center p-8 space-x-8">
		<router-link :to="{ name: 'index' }" class="text-gray-50 hover:text-pink-600 focus:text-pink-600 focus:outline-none">
